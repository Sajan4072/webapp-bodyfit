...
{
$sql=mysqli_query($conn,"SELECT password FROM  admin where password='".$_POST['password']."' && username='".$_SESSION['username']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($conn,"update admin set password='".md5($_POST['newpassword'])."'  where username='".$_SESSION['username']."'");
