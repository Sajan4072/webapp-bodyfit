...
<?php 
$status='Delivered';
$query=mysqli_query($conn,"select *from ads");
$cnt=1;
...
?>										
										<tr>
											...
											<td><?php echo htmlentities($row['image3']);?></td>
										 ...
										 <td><?php echo htmlentities($row['postedby']);?></td>
										   ...
										   <td><a href="updateorder.php?oid=<?php echo $row['oid'] ?>"><i class="icon-edit"></i></a></td>
									</tr>
