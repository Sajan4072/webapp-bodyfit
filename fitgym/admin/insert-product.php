...
if(strlen($_SESSION['username'])==0)
...
else  
  {
     ...
     if(isset($_POST['submit']))
   {
	...
	$queery="insert into 
	             products(name,productcompany,productprice,productDescription,productavilability,image,admin,dates)    
	             values('$productname','$productcompany','$productprice','$productdescription','$productavailability','$productimage1',
	             '$admins','$dates')";
